                    ...
                    <div class="grid gap-8 md:grid-cols-3">
                        <div class="border border-zinc-800 bg-zinc-900/40 p-5">
                            ...
                            <p class="mt-3 text-sm leading-6 text-zinc-400">
                                Enciclopédia de entidades, locais amaldiçoados, fenômenos, objetos malditos e linhas do
                                tempo sobrenaturais.
                            </p>
                        </div>
                        ...
                        <div class="border border-zinc-800 bg-zinc-900/40 p-5">
                            ...
                            <p class="mt-3 text-sm leading-6 text-zinc-400">
                                Debata teorias, compartilhe relatos, discuta filmes, séries, jogos e universos de horror
                                com a comunidade.
                            </p>
                        </div>
